  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-indigo-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30 dark:opacity-20">
        <div className="absolute top-1/4 right-1/4 w-48 h-48 bg-purple-200 dark:bg-purple-800 rounded-full mix-blend-multiply dark:mix-blend-lighten filter blur-xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-1/4 left-1/4 w-64 h-64 bg-indigo-200 dark:bg-indigo-800 rounded-full mix-blend-multiply dark:mix-blend-lighten filter blur-xl animate-pulse" style={{ animationDelay: '3s' }}></div>
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="glass dark:glass-dark rounded-3xl shadow-2xl ring-1 ring-gray-200/60 dark:ring-gray-700/60 p-8 animate-scale-in">
          <div className="text-center mb-8">
            ...
            <p className="mt-3 text-sm text-gray-600 dark:text-gray-400">Start organizing your thoughts today</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center text-sm text-gray-600 dark:text-gray-400">
              ...
              <Link href="/auth/signin" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 font-medium transition-colors">
                Sign in
              </Link>
            </div>
          </form>
